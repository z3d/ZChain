...
namespace ZChain
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var secondBlock = new Block(genesisBlock, new Transaction("Second_Address", "Third_Address", 400), 5);
            secondBlock.MineBlock();

            Console.WriteLine(secondBlock);
            Console.WriteLine($"Verified: {Block.VerifyHash(secondBlock)}");

            var thirdBlock = new Block(secondBlock, new Transaction("ThirdAddress", "FourthAddress", 400), 5);
